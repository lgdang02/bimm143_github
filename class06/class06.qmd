...
> Q. Write a function to returna DNA sequence of a user specified length? Call it `generate_dna()`
...
We can fix this inability to generate multiple sequences by either editing and adding to the function body code (e.g. for a loop) or by using the R **apply** family of utility functions.
