...
There are two main inputs we need for the analysis:
...
There are 4 controls cell lines we have.
...
> Q5. Remove any “zero count” genes from out dataset for further
> analysis
...
The first function we will use from this package sets up input in the
particular format that DESeq wants:
...
Gene symbols and different datbase IDs
...
```
    ...
    Info: Working in directory /Users/lgdang/Desktop/courses/BIMM143/bimm143_github/class13

    Info: Writing image file hsa05310.pathview.png

![The Asthma pathway overlaps with our differentially exppresed
